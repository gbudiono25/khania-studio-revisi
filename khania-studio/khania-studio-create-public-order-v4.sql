...
-- Fix: ambiguous "client_code" in INSERT ... RETURNING
--
-- Perubahan V4:
...
--
-- client_code tetap diambil setelah INSERT order melalui SELECT
-- yang sudah ada di V3. Tidak mengubah alur bisnis V3 lainnya.
-- ============================================================
...
begin
  ...
  if v_client_id is null then
    ...
    -- V4: jangan mengembalikan client_code di sini.
    -- client_code adalah nama output variable function dan
    -- menyebabkan ambiguity pada PL/pgSQL.
    returning id
      into v_client_id;
  end if;
