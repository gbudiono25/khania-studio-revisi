 ...
 * SMTP credentials are loaded from .env and are never stored in this PHP source.
 */
...
if ($smtpHost === '' || $smtpUsername === '' || $smtpPassword === '') {
    error_log('Khania Studio Brief: SMTP configuration is missing from .env.');
    fail('Server belum memiliki konfigurasi email yang lengkap. Silakan hubungi Khania Studio.', 500);
}
